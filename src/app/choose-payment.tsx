...
export function ChoosePaymentComponent({
  ...
  return (
    <div className="flex flex-col items-center justify-between space-y-8 px-2 pb-8 pt-4">
      <div className="flex w-full space-x-1 text-primary">
      ...
      <div className="flex w-full flex-col items-center">
        ...
        <p className="mb-4 text-xl font-semibold">
          <span className="text-purple-500">$99 pesos</span>{" "}
